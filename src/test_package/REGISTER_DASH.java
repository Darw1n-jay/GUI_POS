...
public class REGISTER_DASH extends javax.swing.JFrame {
    ...
    public REGISTER_DASH() {
        initComponents();
        AppUI.setupFrame(this, "Coffee Shop POS - Register", true);
        AppUI.setPlaceholder(USER_NAME, "Username");
        AppUI.setPasswordFieldFeatures(PASSWORD, "Password (min 6 chars)");
        AppUI.makeSecondary(LOGIN);
        AppUI.makePrimary(CREATE);
        AppUI.setupDefaultButton(this, CREATE);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new REGISTER_DASH().setVisible(true));
    }
